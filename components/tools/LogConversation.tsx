...
export function LogConversation({ accountData, setAccountData }: ToolProps) {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-end mb-2">
        <p className="text-sm text-gray-600">
          Log your conversations and outreach for{" "}
      ...
      <div className="bg-slate-50 border border-slate-200 rounded-xl p-5 shadow-sm">
        <h4 className="font-semibold text-slate-800 mb-4 flex items-center gap-2">
          <Calendar className="w-4 h-4 text-slate-500" /> Conversation History
        ...
        {logs.length === 0 ? (
          <div className="text-center py-8 text-slate-400 text-sm italic">
            No conversations logged yet. Start dialing!
          </div>
        ) : (
